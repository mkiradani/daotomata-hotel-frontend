...
export const ContactForm = component$<ContactFormProps>(
  ({ hotelId, hotelName, contactMethods = [] }) => {
      ...
      return (
        <div class="bg-success/10 p-8 border border-success/20 rounded-lg text-center">
          ...
          <p class="mb-6 font-secondary text-base-content/70">
            Thank you for contacting {hotelName}. We'll get back to you as soon
            as possible.
          </p>
          <button
            type="button"
      ...
      <div class="bg-base-200 p-8 rounded-lg">
        ...
        <form onSubmit$={handleSubmit} class="space-y-6">
          ...
          <div>
            <label
              for="email"
              class="block mb-2 font-secondary font-medium text-sm text-base-content"
            >
              Email Address *
            </label>
            <input
          ...
          <div class="pt-4 text-center">
            <p class="font-secondary text-xs text-base-content/60">
              By submitting this form, you agree to be contacted by {hotelName}{" "}
              regarding your inquiry. We respect your privacy and will not share
              ...
              {contactMethods.map((method) => {
                ...
                return (
                  <a
                    ...
                    href={display.href}
                    target={
                      method.contact_type === "whatsapp" ? "_blank" : undefined
                    }
                    rel={
