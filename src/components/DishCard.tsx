...
export const DishCard = component$<DishCardProps>(({
  ...
  return (
    <div class={`bg-base-100 border-2 border-base-300 card overflow-hidden ${!isAvailable ? 'opacity-60' : ''}`}>
      {imageUrl && (
      ...
      <div class="p-4 card-body">
        <h3 class="mb-2 font-head text-primary text-lg card-title">
          {name}
        </h3>
        ...
        {ingredients && ingredients.length > 0 && (
          <div class="mb-3">
            <div class="text-xs text-base-content/50 uppercase tracking-wide mb-1">Ingredients</div>
