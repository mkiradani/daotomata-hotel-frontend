          ...
          <div class="flex flex-wrap gap-4 mb-6 text-sm text-base-content/70">
            ...
            {dietary_options && dietary_options.length > 0 && (
              <div class="flex items-center">
                ...
                {dietary_options.slice(0, 2).map(formatDietaryOption).join(', ')}
                {dietary_options.length > 2 && ` +${dietary_options.length - 2} more`}
              </div>
            )}
            {calories && (
              <div class="flex items-center">
            ...
            <div class="text-left">
              ...
              {allergens && allergens.length > 0 && (
                <div class="mt-2 text-xs text-base-content/50">
                  Allergens: {allergens.slice(0, 2).map(formatAllergen).join(', ')}
