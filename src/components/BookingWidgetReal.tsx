  ...
  const submitBooking = $(async () => {
    ...
    try {
      ...
      if (bookingData.success && bookingData.booking.success) {
        ...
        alert(`Booking successful! Confirmation: ${bookingData.booking.confirmationNumber || bookingData.booking.bookingId}`);
        ...
        throw new Error(bookingData.error || bookingData.booking?.error || 'Failed to create booking');
      }
                      ...
                      <div class="card-body">
                        <div class="flex justify-between items-start">
                          <div class="flex-1">
                            ...
                            {description && (
                              <p class="opacity-70 mb-2 text-sm">{description}</p>
                            )}
                            ...
                            {rate && (
                              <div class="mt-2">
                                <p class="text-sm">
                                  Base price: {formatPrice(rate.basePrice, rate.currency)} per night
                                </p>
                          ...
                          <div class="text-right">
                            <div class="font-bold text-primary text-2xl">
                              {rate ? formatPrice(rate.totalPrice, rate.currency) : formatPrice(room.price, room.currency)}
                            </div>
              ...
              <div class="bg-primary/10 mb-6 card">
                <div class="card-body">
                  ...
                  <div class="gap-4 grid grid-cols-2 text-sm">
                    ...
                    <div>
                      <p><strong>Guests:</strong> {adults.value} adults{children.value > 0 ? `, ${children.value} children` : ''}</p>
                      <p><strong>Rooms:</strong> {rooms.value}</p>
                      <div class="text-right">
                        <div class="font-bold text-primary text-xl">
                          {(() => {
                            const rate = getRoomRate(selectedRoom.value!.roomId);
                            return rate ? formatPrice(rate.totalPrice, rate.currency) : formatPrice(selectedRoom.value!.price, selectedRoom.value!.currency);
                          })()}
                        </div>
              ...
              <div class="space-y-4">
                ...
                <div class="justify-end pt-4 card-actions">
                  ...
                  <button
                    ...
                    disabled={isLoading.value || !guestFirstName.value || !guestLastName.value || !guestEmail.value}
                  >
