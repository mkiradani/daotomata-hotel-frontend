...
interface FooterProps {
  ...
  isSubdomain?: boolean; // For URL generation
  hotelInfo?: HotelInfo;
}
          ...
          <div class="gap-8 grid grid-cols-1 md:grid-cols-4">
            ...
            <div>
              ...
              <ul class="space-y-2">
                ...
                <li>
                  <a
                    href={generateUrl('/accommodation')}
                    class="hover:text-primary text-base-content/70 transition-colors"
                  >
                    Accommodation
                  </a>
