      ...
      <div class="mx-auto max-w-7xl container">
        <div class="gap-8 grid grid-cols-1 md:grid-cols-4">
          ...
          <div class="md:col-span-2">
            ...
            <p class="mb-4 text-base-content/80 leading-relaxed">
              Experience luxury and comfort at {hotelName}. We provide exceptional hospitality 
              with modern amenities and thoughtful service.
            </p>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li>
                <a href={`/${hotelSlug}`} class="hover:text-primary text-base-content/70 transition-colors">
                  Home
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/accommodation`} class="hover:text-primary text-base-content/70 transition-colors">
                  Accommodation
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/facilities`} class="hover:text-primary text-base-content/70 transition-colors">
                  Facilities
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/experiences`} class="hover:text-primary text-base-content/70 transition-colors">
                  Experiences
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/restaurant`} class="hover:text-primary text-base-content/70 transition-colors">
                  Restaurant
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/contact`} class="hover:text-primary text-base-content/70 transition-colors">
                  Contact
                </a>
              </li>
              <li>
                <a href={`/${hotelSlug}/book`} class="hover:text-primary text-base-content/70 transition-colors">
                  Book Now
                </a>
              </li>
            </ul>
        ...
        <div class="flex md:flex-row flex-col justify-between items-center mt-8 pt-8 border-t border-base-300">
          ...
          <div class="flex space-x-6 mt-4 md:mt-0">
            <a href="#" class="hover:text-primary text-sm text-base-content/60 transition-colors">
              Privacy Policy
            </a>
            <a href="#" class="hover:text-primary text-sm text-base-content/60 transition-colors">
              Terms of Service
