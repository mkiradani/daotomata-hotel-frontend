...
export const GET: APIRoute = async () => {
  try {
    console.log("🔍 [DEBUG EXHAUSTIVO] Iniciando investigación de postPayment...");
    ...
    console.log(`🔍 [DEBUG] Hotel: ${hotel.name} (Property ID: ${hotel.cloudbeds_property_id})`);
    ...
    try {
      ...
      jsonResult = { error: error instanceof Error ? error.message : 'Unknown error' };
    }
    ...
    try {
      ...
      formResult = { error: error instanceof Error ? error.message : 'Unknown error' };
    }
    ...
    try {
      ...
      altResult = { error: error instanceof Error ? error.message : 'Unknown error' };
    }
